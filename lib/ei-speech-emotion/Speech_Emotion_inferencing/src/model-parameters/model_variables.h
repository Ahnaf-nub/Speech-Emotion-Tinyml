...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 27
        ...
        (void*)&ei_dsp_config_27, // pointer to config struct
        ei_dsp_config_27_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_27_axes_size, // number of axes
        1, // version
        nullptr, // factory function
    }
};
const ei_config_tflite_eon_graph_t ei_config_tflite_graph_28 = {
    .implementation_version = 1,
    .model_init = &tflite_learn_28_init,
    .model_invoke = &tflite_learn_28_invoke,
    .model_reset = &tflite_learn_28_reset,
    .model_input = &tflite_learn_28_input,
    .model_output = &tflite_learn_28_output,
};

ei_learning_block_config_tflite_graph_t ei_learning_block_config_28 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_28_inputs[1] = { 27 };
const uint8_t ei_learning_block_28_inputs_size = 1;
...
const ei_impulse_t impulse_692312_0 = {
    .project_id = 692312,
    .project_owner = "Ahnaf",
...
ei_impulse_handle_t impulse_handle_692312_0 = ei_impulse_handle_t( &impulse_692312_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_692312_0;
