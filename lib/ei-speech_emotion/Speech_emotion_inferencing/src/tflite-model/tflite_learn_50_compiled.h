...
#ifndef tflite_learn_50_GEN_H
#define tflite_learn_50_GEN_H
...
TfLiteStatus tflite_learn_50_reset( void (*free)(void* ptr) );


// Returns the number of input tensors.
inline size_t tflite_learn_50_inputs() {
  return 1;
}
// Returns the number of output tensors.
inline size_t tflite_learn_50_outputs() {
  return 1;
}
